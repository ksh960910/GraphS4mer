...
from data.datamodules.datamodule_dreem_dodh import DODH_DataModule
...
class PLModel(pl.LightningModule):
    ...
    def _build_model(self):
        ...
        elif args.dataset == "dodh" or args.dataset == "ours":
...
def main(args):
    ...
    # Tensorboard log
    # logger = TensorBoardLogger('logs/', name='dodh_'+str(args.sampling_freq)+'_16-other6EEG')
    logger = TensorBoardLogger('logs/', name='ours'+str(args.sampling_freq)+'_10ch25pat'+str(args.dropout))
    ...
    if args.dataset == "tuh":
        ...
        raise NotImplementedError
    print('DOD-H frequency : ', args.sampling_freq)
    ...
    if args.do_train:
        ...
        if not (args.gpus > 1):
            ...
            trainer = pl.Trainer(
                ...
                benchmark=False,
                num_sanity_val_steps=0,
                devices=torch.cuda.device_count(), #[0,1,2,3]
                accumulate_grad_batches=args.accumulate_grad_batches,
            )
